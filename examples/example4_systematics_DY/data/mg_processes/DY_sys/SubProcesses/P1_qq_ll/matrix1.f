...
C     
C     Process: u u~ > mu+ mu- NP<=2 QCD=0 QED<=99 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFFF3_4_8_9_0(W(1,3),W(1,4),W(1,1),W(1,2),GC_46,GC_54,GC_58
     $ ,GC_61,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_2,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,3),W(1,4),W(1,5),GC_3,AMP(2))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_28,GC_35,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_4_0(W(1,3),W(1,4),W(1,5),GC_27,GC_36,AMP(3))
